...
{
    public static class WaspGunProfile
    {
        private const int MinWaspCount = 2;
        private const int MaxWaspCount = 4;
        ...
        {
            int waspCount = Main.rand.Next(
                MinWaspCount,
                MaxWaspCount + 1
            );

            NeuroWeaponShot[] shots = new NeuroWeaponShot[waspCount];
